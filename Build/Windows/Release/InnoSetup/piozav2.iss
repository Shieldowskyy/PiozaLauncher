...
Root: HKCR; Subkey: "pioza\shell\open\command"; ValueType: string; ValueName: ""; ValueData: "pythonw.exe ""{app}\Tools\bootstrapper\pioza_bootstrap.py"" ""%1"""; Flags: uninsdeletekey
